...
const ArchitectureCanvas = dynamic(() => import('./three/ArchitectureCanvas'), {
  ssr: false,
  loading: () => <div className="h-full w-full bg-[#F4F3F0]" />,
})
...
export default function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      id="top"
      className="relative h-svh min-h-[720px] overflow-hidden bg-[#F4F3F0]"
    >
      <div
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#F4F3F0]/96 via-[#F4F3F0]/55 to-transparent md:via-[#F4F3F0]/35" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#F4F3F0]/95 to-transparent" />
      ...
      <div className="pointer-events-none relative z-10 mx-auto flex h-full max-w-7xl flex-col justify-end px-6 pb-24 pt-28 md:justify-center md:px-12 md:pb-0">
        ...
        >
          ...
          <h1 className="mt-6 font-serif text-5xl font-light leading-[0.9] tracking-tight text-[#171717] drop-shadow-[0_2px_20px_rgba(0,0,0,0.9)] md:text-7xl">
            Design you
            <br />
            can walk
            <br />
          ...
          <p className="mt-8 max-w-xl text-base leading-relaxed text-[#77736B] drop-shadow-[0_1px_10px_rgba(0,0,0,0.95)] md:text-lg">
        ...
        >
          {STATS.map((stat) => (
            <div key={stat.label}>
              <p className="font-serif text-3xl font-light tracking-tight text-[#171717]">
                {stat.value}
              </p>
              <p className="mt-1 text-xs uppercase tracking-[0.2em] text-[#77736B]">
                {stat.label}
              </p>
            </div>
          ))}
      ...
      <motion.p
        ...
        className="pointer-events-none absolute bottom-10 right-12 hidden text-xs uppercase tracking-[0.2em] text-[#77736B] lg:block"
      >
        Drag to orbit
      </motion.p>
      ...
      <a
        ...
        className="absolute bottom-8 left-6 z-10 inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[#77736B] transition-colors duration-500 hover:text-[#171717] md:left-12"
      >
        Scroll
