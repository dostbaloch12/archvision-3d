  ...
  return (
    ...
    >
      <div className="mx-auto max-w-4xl px-6 text-center md:px-12">
        <p className="text-xs uppercase tracking-[0.2em] text-[#171717]">Client Words</p>
        ...
        <div className="mt-16 min-h-[300px]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="mt-8 text-xs uppercase tracking-[0.2em] text-[#171717]">{active.name}</p>
        ...
        <div className="mt-12 flex items-center justify-center gap-4">
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center border border-white/40 text-white transition-colors duration-500 ease-out hover:border-[#171717] hover:bg-[#171717] hover:text-[#171717]"
          >
            <ChevronLeftIcon />
          </button>
