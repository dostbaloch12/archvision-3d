...
export default function Testimonials() {
  ...
  return (
    <section
      className="bg-gradient-to-b from-[#9370BC] to-[#B489C2] py-24 md:py-32"
      aria-label="Client testimonials"
    >
      <div className="mx-auto max-w-4xl px-6 text-center md:px-12">
        <p className="text-xs uppercase tracking-[0.2em] text-[#2E1A47]">Client Words</p>
        ...
        <div className="mt-16 min-h-[300px]">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="mt-8 text-xs uppercase tracking-[0.2em] text-[#2E1A47]">{active.name}</p>
        ...
        <div className="mt-12 flex items-center justify-center gap-4">
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center border border-white/40 text-white transition-colors duration-500 ease-out hover:border-[#2E1A47] hover:bg-[#2E1A47] hover:text-[#F6DCE8]"
          >
            <ChevronLeftIcon />
          </button>
