...
export default function ProjectShowcase() {
  ...
  return (
    <section
      id="projects"
      className="scroll-mt-24 bg-gradient-to-b from-[#171717] to-[#171717] py-24 md:py-32"
    >
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-serif text-4xl font-light leading-[1.05] tracking-tight text-white md:text-5xl">
              Buildings that hold
              <span className="text-[#171717]"> their silence.</span>
            </h2>
          </div>
            ...
            return (
              <button
                ...
                className={`border px-4 py-2 text-xs uppercase tracking-[0.2em] transition-colors duration-500 ease-out ${
                  isActive
                    ? 'border-[#77736B] bg-[#77736B] text-[#F4F3F0]'
              ...
              >
                ...
                >
                  <div className={`relative ${project.ratio} min-h-[280px]`}>
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#171717] via-[#171717]/30 to-transparent opacity-85 transition-opacity duration-500 group-hover:opacity-95" />
      ...
      <AnimatePresence>
        {active ? (
          <motion.div
            ...
            className="fixed inset-0 z-[70] flex flex-col bg-[#F4F3F0]"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="flex flex-1 flex-col overflow-y-auto lg:flex-row">
              ...
              <aside className="w-full shrink-0 border-t border-white/15 bg-[#F4F3F0] p-6 md:p-10 lg:w-[420px] lg:border-l lg:border-t-0">
                <p className="text-xs uppercase tracking-[0.2em] text-[#77736B]">
