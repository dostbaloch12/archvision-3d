  ...
  return (
    <main className="bg-[#F4F3F0] text-[#171717]">
      ...
      <section className="relative min-h-[80vh] overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#F4F3F0] via-[#F4F3F0]/75 to-transparent" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[80vh] max-w-7xl flex-col justify-end px-6 pb-20 pt-28 md:px-12">
          ...
          <p className="text-xs uppercase tracking-[0.2em] text-[#171717]">
      ...
      <section className="bg-gradient-to-b from-[#F4F3F0] to-[#171717] py-20 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 md:grid-cols-3 md:px-12">
          <article className="border border-white/15 bg-white/5 p-7">
            <p className="text-xs uppercase tracking-[0.2em] text-[#FBFAF7]">Challenge</p>
          ...
          <article className="border border-white/15 bg-white/5 p-7">
            <p className="text-xs uppercase tracking-[0.2em] text-[#FBFAF7]">Solution</p>
            <h2 className="mt-4 font-serif text-2xl font-light tracking-tight text-white">
              The response.
            </h2>
          ...
          <article className="border border-white/15 bg-white/5 p-7">
            <p className="text-xs uppercase tracking-[0.2em] text-[#FBFAF7]">Result</p>
            <h2 className="mt-4 font-serif text-2xl font-light tracking-tight text-white">
              The outcome.
            </h2>
