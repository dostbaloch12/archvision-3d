...
export default function PrivacyPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#F4F3F0] to-[#D9D6CF] py-24 md:py-32">
      <div className="mx-auto max-w-3xl px-6 md:px-12">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[#77736B] transition-colors duration-500 hover:text-[#171717]"
        >
          <svg
        ...
        <p className="mt-12 text-xs uppercase tracking-[0.2em] text-[#171717]">Legal</p>

        <h1 className="mt-4 font-serif text-4xl font-light tracking-tight text-[#171717] md:text-5xl">
          Privacy Policy
        </h1>
        ...
        <div className="mt-14 space-y-10">
          {SECTIONS.map((section) => (
            <section key={section.heading}>
              <h2 className="text-xl font-light tracking-tight text-[#171717]">
                {section.heading}
              </h2>
          ...
          <section className="border-t border-[#D9D6CF] pt-10">
            <h2 className="text-xl font-light tracking-tight text-[#171717]">Contact</h2>
            <p className="mt-3 text-base text-[#77736B] md:text-lg">
              For privacy requests, write to{' '}
              <a
                href="mailto:studio@archvision3d.com"
                className="text-[#171717] transition-colors duration-500 hover:text-[#FBFAF7]"
              >
