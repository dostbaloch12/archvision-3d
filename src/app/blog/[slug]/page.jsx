    ...
    <main className="bg-[#f4f2ed] text-[#171715]">
      ...
      <article>
        <header className="site-container border-b border-[#d7d3ca] pb-20 pt-36">
          <a href="/blog" className="editorial-textlink">
            Back to journal
          </a>
        ...
        <section className="site-container max-w-4xl py-20">
          <div className="space-y-12">
            {post.sections.map((section) => (
              <section key={section.heading}>
                ...
                <p className="mt-5 text-[16px] leading-[1.85] text-[#6c6961]">
                  {section.body}
                </p>
              </section>
            ))}
            ...
            <div className="mt-8 space-y-8">
              {post.faqs.map((faq) => (
                <section key={faq.question}>
                  ...
                  <p className="mt-3 text-[15px] leading-[1.75] text-[#77746c]">
                    {faq.answer}
                  </p>
                </section>
              ))}
          ...
          <div className="mt-12 border border-[#d7d3ca] bg-[#eeece6] p-8">
            ...
            <a href="/#contact" className="editorial-button mt-8">
              Start a project ↗
            </a>
          </div>
        </section>
